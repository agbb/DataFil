...
import Foundation
/**
 Implementation and adaptation of the filter algorithm presented in A Direct Algorithm for 1D Total Variation Denoising (L.Condat, 2013): https://hal.inria.fr/file/index/docid/681648/filename/condat_fast_tv.pdf
 */
class TVDenoising{
